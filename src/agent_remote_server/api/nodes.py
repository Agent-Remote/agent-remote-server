...
def node_data(node: Node) -> NodeData:
    ...
    return NodeData(
        ...
        allowed_runtime_backends=node.allowed_runtime_backends,
...
async def create_node(
    ...
    result = await NodeService(session, settings).create_node(
        ...
        allowed_runtime_backends=payload.allowed_runtime_backends,
        default_runtime_backend=payload.default_runtime_backend,
